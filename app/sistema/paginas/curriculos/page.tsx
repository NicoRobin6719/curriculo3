...
export default function ListaCurriculosPage() {
  ...
  const curriculosFiltrados = curriculosMock.filter((curriculo) =>
    ...
    >
      ...
      >
        ...
        <Link
          ...
          className="
            rounded-lg bg-indigo-600 px-5 py-2 font-medium text-white
            transition hover:bg-indigo-500 hover:scale-105
          "
        >
          + Novo Currículo
        </Link>
